...
### Save results
fwrite(Hoge_parameters, paste0("./output/tmp/Table_xgboost_params_round_r1.csv"))
...
### Save results
fwrite(Hoge_parameters, paste0("./output/tmp/Table_xgboost_params_round_r2.csv"))
Next_parameters <- Tune_params[NO == Hoge_parameters[RMSE_val == min(RMSE_val), first(NO), ], , ]
Next_parameters
...
### Save results
fwrite(Hoge_parameters, paste0("./output/tmp/Table_xgboost_params_round_r3.csv"))
Next_parameters <- Tune_params[NO == Hoge_parameters[RMSE_val == min(RMSE_val), first(NO), ], , ]
Next_parameters
...
### Save results
fwrite(Hoge_parameters, paste0("./output/tmp/Table_xgboost_params_round_r4.csv"))
Next_parameters <- Tune_params[NO == Hoge_parameters[RMSE_val == min(RMSE_val), first(NO), ], , ]
Next_parameters
...
### Save results
fwrite(Hoge_parameters, paste0("./output/tmp/Table_xgboost_params_round_r5.csv"))
Next_parameters <- Tune_params[NO == Hoge_parameters[RMSE_val == min(RMSE_val), first(NO), ], , ]
Next_parameters


Next_parameters[, Nround := Hoge_parameters[RMSE_val == min(RMSE_val), Nround, ], ]
fwrite(Next_parameters, paste0("./output/Table_xgboost_params_round_best.csv"))
...
#----------------#----------------#----------------
Best_list <- fread(paste0("./output/Table_xgboost_params_round_best.csv"))
Best_list
...
saveRDS(Model, paste0("./models/XGBoost_best.rds")) 
toc()
...
importance
fwrite(importance, paste0("./output/xgboost_feature_importance_.csv"))
